...
public class Texture {
	...
	private void createTextureFromImage(BufferedImage image, int mipMapLevel) {
		...
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR); //größer werden
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR); //kleiner werden
